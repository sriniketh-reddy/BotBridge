    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900">
      <div className="w-full max-w-md p-6">
        <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 shadow rounded-lg p-6">
          ...
          <input type="text" placeholder="Full name" className="mt-1 mb-3 block w-full rounded-md border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2" onChange={(e) => setForm({ ...form, name: e.target.value })} />
